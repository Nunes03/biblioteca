...
import main.java.br.com.biblioteca.entities.LivroEntity;
import main.java.br.com.biblioteca.queries.interfaces.LivroQueryInterface;
...
public class LivroQuery implements LivroQueryInterface {
	...
	@Override
	public String criar(LivroEntity entity) {
	...
	@Override
	public String atualizar(LivroEntity entity) {
		return String.format(
			UPDATE_QUERY,
			entity.getNome(),
			entity.getDescricao(),
