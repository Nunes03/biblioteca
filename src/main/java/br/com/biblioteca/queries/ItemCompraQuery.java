...
import main.java.br.com.biblioteca.entities.ItemCompraEntity;
import main.java.br.com.biblioteca.queries.interfaces.ItemCompraQueryInterface;
...
public class ItemCompraQuery implements ItemCompraQueryInterface {
	...
	@Override
	public String criar(ItemCompraEntity entity) {
	...
	@Override
	public String atualizar(ItemCompraEntity entity) {
		return String.format(
			UPDATE_QUERY,
			entity.getCompra().getId(),
			entity.getAcervo().getId(),
